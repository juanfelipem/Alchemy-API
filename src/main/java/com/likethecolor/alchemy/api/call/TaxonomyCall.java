...
public class TaxonomyCall extends AbstractCall<TaxonomyAlchemyEntity> {
    public TaxonomyCall(final CallType callType) {
        this(callType, new CategoryParams());
    }

    public TaxonomyCall(final CallType callType, final Params params) {
        super(callType, params);
    }

    @Override
    public String getName() {
        return Constants.CALL_NAME_CATEGORY;
    }
